...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 07, 2020 at 12:38 PM
...
INSERT INTO `admins` (`admin_id`, `admin_email`, `admin_password`, `role_admin`, `admin_firstname`, `admin_lastname`, `admin_address`, `admin_contact_info`, `admin_photo`, `admin_status`, `admin_activate_code`, `admin_reset_code`, `created_on`, `role`) VALUES
(17, 'a@a.com', '12', 'superadmin', 'sadi ', 'ashlaq', '', '', '', 0, '', '', '0000-00-00', 'admin'),
(33, 'anasmahmoud.mel@gmail.com', '123456', 'admin', 'Anas ', 'Melhem', '', '', '', 0, '', '', '0000-00-00', 'admin');
...
(92, 'osama', '', 'images/admin_images/2.jpg');
