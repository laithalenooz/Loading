            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <nav aria-label="breadcrumb" class="theme-breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.php">Home</a> / <a class='text-dark' href='category-page.php'>Category</a></li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <div class='row'>
        <div class='col-lg-6'>
            <div class='product-slick'>
                <!-- Item image -->
                <div><img src='./admin/{$pro['pro_photo']}' alt=''
                          class='img-fluid lazyload image_zoom_cls-0'></div>
            </div>
        </div>
        <div class='col-lg-6 rtl-text'>
            <div class='product-right'>
                <h2>{$pro['pro_name']}</h2>
                <h3>{$pro['pro_price']}</h3>
                <div class='product-buttons'><a href='cart.php?id={$pro['pro_id']}&cart_id={$pro['pro_id']}' class='btn btn-solid'>add to cart</a></div>
